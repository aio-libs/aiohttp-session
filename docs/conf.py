...
# -*- coding: utf-8 -*-
#
# aiohttp_session documentation build configuration file, created by
...
htmlhelp_basename = 'aiohttp_sessiondoc'
...
latex_documents = [
    (master_doc, 'aiohttp_session.tex', 'aiohttp\\_session Documentation',
...
man_pages = [
    (master_doc, 'aiohttp_session', 'aiohttp_session Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aiohttp_session', 'aiohttp_session Documentation',
     author, 'aiohttp_session', 'One line description of project.',
     'Miscellaneous'),
]
